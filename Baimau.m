...
switch (type_geometric)
 case 1
 length=1000; % mm thay doi
 emodul=100e3; % MPa (N/mm^2) thay doi
 area=power(2.5,2)*10^2; % mm^2 thay doi
 force=100e3; % N thay doi ne
...
for row_indx=1:non
 ...
 fprintf('kk(%d,%d)=tmp+k(%d,%d,%d)\r\n',(row_indx-1)*edof+i,(col_indx-1)*edof+j,(n1-1)*edof+i,(n1-1)*edof+i,e)
 end
 end
 end
 end
